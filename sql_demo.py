...
def create_connection():
    return pymysql.connect(
        # host="host.docker.internal",  # Your MySQL server host from localhost
        # host="172.17.0.2",  # Your MySQL container to other container through IP
        host="mysqldb",  # Your MySQL server host from network (two container in one network)
